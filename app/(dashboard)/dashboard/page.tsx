...
export default function DashboardPage() {
  ...
  // If we have a 401 error, it means the session is invalid or still settling.
  // We treat 401s as a loading state to prevent transient failures from breaking the UI.
